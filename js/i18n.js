(function () {
    ...
    let TRANSLATIONS = {
        en: {
            ...
            'method.graph-hopcroft-karp': 'Hopcroft-Karp Bipartite Matching',
            ...
            'method.hyperloglog':           'HyperLogLog',
            ...
            'method.manacher':              "Manacher's Algorithm",
        ...
        zh: {
            ...
            'method.graph-hopcroft-karp':   'Hopcroft-Karp 二分圖最大匹配',
            ...
            'method.hyperloglog':           'HyperLogLog 基數估計',
            ...
            'method.manacher':              'Manacher 最長回文演算法',
            'method.search-aho':            'Aho-Corasick',
