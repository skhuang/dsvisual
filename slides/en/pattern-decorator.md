...
1. Create a base `SimpleCoffee` object (description: "Simple Coffee", cost: $2.00).
2. Wrap with `MilkDecorator`: `getDescription()` returns "Simple Coffee + Milk", cost adds $0.50.
3. Wrap with `SugarDecorator`: description appends "+ Sugar", cost adds another $0.25.
