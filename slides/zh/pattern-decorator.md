...
1. 建立基本 `SimpleCoffee` 物件(描述:"Simple Coffee",費用:2.00 元)。
2. 以 `MilkDecorator` 包裝,呼叫 `getDescription()` 回傳 "Simple Coffee + Milk",費用增加 0.50 元。
3. 再以 `SugarDecorator` 包裝,描述繼續追加 "+ Sugar",費用再加 0.25 元。
